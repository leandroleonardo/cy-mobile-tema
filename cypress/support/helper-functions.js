...
export function getHexadecimal(cor) {
  ...
  //console.log(temas[temaAtual][cor], temas[temaAtual][variavelCSS])
...
export function singleGet(get) {
  return cy.get(get, { timeout: 1000 });
}

export function getViewByComponent(component) {
  let cenario1 = ['Link', 'Avaliação', 'Ícone', 'Botão','toggle', 'Caixa de checagem']; // , 'Envio de arquivo'
